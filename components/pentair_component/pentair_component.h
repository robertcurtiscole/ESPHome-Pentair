...
class PentairRS422 : public uart::UARTDevice, public Component {
 public:
  ...
  void set_spa_on_switch(esphome::pentair_component::PentairSwitch *spa_on_switch) { spa_on_switch_ = spa_on_switch; }
  ...
  // protected variables
 protected:
  esphome::pentair_component::PentairSwitch *spa_on_switch_{nullptr};
